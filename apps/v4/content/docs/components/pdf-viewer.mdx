...
```bash
npm install @hugeicons/core-free-icons@^4.2.0 @hugeicons/react@^1.1.6 @tanstack/react-virtual@^3.13.26 pdf-lib@^1.17.1 pdfjs-dist@5.4.296 react-pdf@^10.4.1
```
...
<DocsMdxCodeBlock
  ...
  code={`import "react-pdf/dist/Page/TextLayer.css"`}
/>

<Step>Self-host PDF.js assets if your app cannot fetch from unpkg.</Step>
