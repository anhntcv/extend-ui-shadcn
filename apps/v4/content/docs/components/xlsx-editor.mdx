...
```bash
npx shadcn@latest add https://ui.extend.ai/r/xlsx-editor.json
```
...
```bash
npx shadcn@latest add https://ui.extend.ai/r/xlsx-viewer.json https://ui.extend.ai/r/group.json
```
