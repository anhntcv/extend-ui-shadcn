...
```bash
npx shadcn@latest add https://ui.extend.ai/r/document-viewer-sidebar.json
```
...
<Step>Copy `components/ui/document-viewer-sidebar.tsx` from the registry item into your project.</Step>
