...
```bash
npm install @base-ui/react@^1.4.1 @extend-ai/react-docx@^0.8.0 @hugeicons/core-free-icons@^4.2.0 @hugeicons/react@^1.1.6
```

<Step>
  Install the File Thumbnail and Toggle components because the editor reuses
  them for the page thumbnail rail and formatting controls.
</Step>
